...
public class PunjabiNews extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_punjabi_news, container, false);
        RecyclerView recyclerView = (RecyclerView) view.findViewById(R.id.punjabiNewsRecycler);
        reference = FirebaseDatabase.getInstance().getReference("PunjabiNews");
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        shimmerFrameLayout = view.findViewById(R.id.shimmerpunjabi);
